...
<head>
    ...
    <title>用户注册 - <?php echo e(config('app.name', 'Laravel')); ?></title>
    <style>
    ...
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="请输入姓名">
            </div>

            <div class="form-group">
                <label for="email">邮箱地址</label>
                <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="请输入邮箱">
            </div>
